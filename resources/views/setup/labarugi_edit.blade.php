...
@section('page-title')
<h3 class="page-title">Setup Laba Rugi</h3>
@endsection
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="tableDapat">
                          ...
                          <tr id="rowdapat{{$a}}">
                            ...
                            @else
                              <td width="10%"><button type="button" name="remove" id="{{$a}}" class="btn btn-danger btnDapat_remove">X</button></td>
                            @endif
                          </tr>
                          @php
                            $a++;
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="tableKeluar">
                          ...
                          <tr id="rowkeluar{{$a}}">
                            ...
                            @else
                              <td width="10%"><button type="button" name="remove" id="{{$a}}" class="btn btn-danger btnKeluar_remove">X</button></td>
                            @endif
                          </tr>
                          @php
                            $a++;
                      ...
                      <div class="table-responsive">
                        <table class="table table-bordered" id="tableLain">
                          ...
                          <tr id="rowlain{{$a}}">
                            ...
                            @else
                              <td width="10%"><button type="button" name="remove" id="{{$a}}" class="btn btn-danger btnLain_remove">X</button></td>
                            @endif
                          </tr>
                          @php
                            $a++;
