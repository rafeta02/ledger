...
(function (root, factory) {
    ...
    Ssi_upload.prototype.init = function (element) {
        ...
        var $chooseBtn = $('' +
            ...
            '<button class="btn btn-primary waves-effect waves-light"><span class="icon-span-filestyle glyphicon glyphicon-folder-open"></span> <span>' + this.language.chooseFiles + '</span></button>' +
            '</span>').append(element);
    ...
    Ssi_upload.prototype.uploadFiles = function () {// upload the pending files
        ...
        function ajaxLoopRequest(formData, ii) {
            ...
            var ajaxOptions = $.extend({}, {//store the request to the uploadList variable
                ...
                processData: false,
                headers: {
                   'X-CSRF-Token': thisS.options.token,
                   'id': thisS.options.id_aktivitas
                },
